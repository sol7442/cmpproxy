...
<%
	try {
		...
		String chartUrl = "http://demo.initech.com:8111/initech/html5/cmp/cmp_gate.jsp";
...
// 		int postDataLength = postData.length;
		...
		if (chartUrl != null) {
			...
			try{
				...
				throw new Exception("[ERROR_111]HTTP Connection Fail : " + es.toString());
			}
	...
	// 			opstrm.close();
				...
				throw new Exception("[ERROR_112]HTTP Read/Write Fail : " + ex.toString());
			}
		}
	} catch (Exception e) {
		//if(PRINT_LOG){
