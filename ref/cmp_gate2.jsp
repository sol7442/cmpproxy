...
<%
	...
	//	byte[] b64dec_msg3 = new BASE64Decoder().decodeBuffer(msg3);
		...
		try{
			...
			throw new Exception("[ERROR_201]네트워크 연결 장애입니다. (" + es.toString() + ")");
		}
		...
		try{
			...
			String b64_msg = new String(Base64Util.encode(bMsg));
			...
			String b64_msg2 = new String(Base64Util.encode(bMsg2));;
